...
const Page1 = () => {
  return (
    <React.Fragment>
        ...
        <button className = ' border-2 md:border-4 border-white py-1.5 md:py-2 px-4 md:px-5 mt-[32rem] md:mt-16 hover:text-base hover:py-2 md:hover:py-2.5 hover:px-5 md:hover:px-6 hover:transition duration-200 hover:transition-delay-100 flex text-sm md:text-base'> SHOP NOW </button>
      </div>
    </React.Fragment>
  )
}
