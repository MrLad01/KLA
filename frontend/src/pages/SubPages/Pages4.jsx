...
const Pages4 = () => {
  return (
    <React.Fragment>
      <div className="page-4 w-full h-152 flex flex-col justify-center">
        <header className='text-center'>Special Packages</header>
        ...
        <div className='grid grid-cols-4 grid-rows-1 mx-20'>
            ...
            <div className='flex flex-col justify'>
                ...
                <h5 className='text-center -ml-6'>$39.00</h5>
            </div>
        </div>
        <button className='text-white bg-primary3 h-16 w-36 mr-auto ml-auto rounded-md mt-12 '>SEE MORE</button>
      </div>
    </React.Fragment>
  )
}
